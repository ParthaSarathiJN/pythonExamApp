...
from Service import createAccountFile , insertDetailFile, insertMediaFile, loginToAccountFile, loginTimeStoreFile, dashboardRetrieveDetailsFile, updateDashboardDetailsFile, captchaRelatedFile, retrieveSecurityQuestionFile
...
def captchaValidateFunction():
    ...
    #print(type(validatedCaptchaValue))
...
def MCQExamStartFunction(emailIDGotten):
    ...
    def actualStartTestFrameMCQFunction():
        ...
        def nextQuestionFunction():
            ...
            def nextQuestionChooserFunction(answerForPrevMCQ):
                global numberCountForMCQQuestion
                global answerForMCQOptionList
                                
                answerForMCQOptionList.append(answerForPrevMCQ)
                
                #print(numberCountForMCQQuestion)
                ...
                def saveTheAnswersAndCountMCQFunction(answerForPrevMCQ):
                    global numberCountForMCQQuestion
                    global answerForMCQOptionList
                    ...
                    for allSingleOption in range(numberCountForMCQQuestion):
                        #print(allSingleOption, AnswerListForMCQRadio[allSingleOption][0], answerForMCQOptionList[allSingleOption])
                ...
                print(answerForMCQRadioButton.get())
                if numberCountForMCQQuestion == 5:
                    nextQuestionButton['state']=DISABLED
                    submitMCQAnswerButton = Button(MCQQuestionAndAnswerFrame, text='Submit Test!', bg='black', fg='white', command=lambda:saveTheAnswersAndCountMCQFunction(answerForMCQRadioButton.get()))
                    submitMCQAnswerButton.place(x=160, y=420)
            
            
            
            nextQuestionButton = Button(MCQQuestionAndAnswerFrame, text='Next', bg='black', fg='white', command=lambda:nextQuestionChooserFunction(answerForMCQRadioButton.get()))
            nextQuestionButton.place(x=160, y=370)
...
def dashboardFunction(emailIDGotten):
    ...
    #print(boolValue, userDetailsData)
    ...
    MCQMarksLabel = Label(MCQOnlyFrame, text = "Marks Scored", bg="black", fg="white", font=("Arial", 18))
    ...
    SBQExamStartButton = Button(SBQOnlyFrame, text='Start Test', bg='black', fg='white')
...
newUserLoginFrameButton.place(x=360, y=3900)
